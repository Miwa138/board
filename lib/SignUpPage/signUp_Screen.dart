...
class _SignUpState extends State<SignUp> with TickerProviderStateMixin {
  ...
  FocusNode _phoneNamberFocusNode = FocusNode();
  ...
  void _submitFormOnGignUp() async {
    final isValid = _signUpFormKey.currentState!.validate();
    if (isValid) {
      if (imageFile == null) {
        GlobalMethod.showErrorDialog(
          error: 'Выберете изображние',
          ctx: context,
        );
        return;
      }
                    ...
                    child: Column(
                      children: [
                        ...
                        TextFormField(
                          textInputAction: TextInputAction.next,
                          onEditingComplete: () => FocusScope.of(context)
                              .requestFocus(_phoneNamberFocusNode),
                        ...
                        Center(
                          child: RichText(
                            text: TextSpan(children: [
                              const TextSpan(
                                text: 'У вас уже есть учётная запись?',
                                style: TextStyle(
                                  color: Colors.white,
                                  fontWeight: FontWeight.bold,
                                  fontSize: 16,
